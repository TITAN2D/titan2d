...
python $TITAN2D_PYUTIL_DIR/createVolcanoKML_POLYGONS_ANIMATION.py $1/vizout $TITAN2D_PYUTIL_DIR
echo "Creating flat KML"
python $TITAN2D_PYUTIL_DIR/createVolcanoKML_POLYGONS_LASTFRAME.py $1/vizout $TITAN2D_PYUTIL_DIR
