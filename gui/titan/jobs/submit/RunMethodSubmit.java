...
public class RunMethodSubmit extends RunMethod {
	...
	/*	
        ...
        index = preprocParms[2].lastIndexOf("/");
        db_path = preprocParms[2].substring(0, index);
        db_dir = preprocParms[2].substring(index + 1);
            ...
            try {
                ...
                if (restartEnabled.compareTo(TitanConstants.TRUE) == 0)  {
                    ...
                    if ( use_irods == 0 ) {
                        ...
                        //writer2.write("getZone.pl " + db_path + " " + basedir + " " + preprocParms[10] + "\n");
        ...
        if ( use_irods == 1 ) {
            try {
                ...
                try {
                    ...
                    writer3.write("\n");
                    //int index = preprocParms[i].lastIndexOf("/");
            ...
            try {
                ...
                try {
                    ...
                    if ( save_dir.isEmpty() ) {
                        ...
                        //writer4.write("imkdir -pV /vhub/home/public/TitanVhubResults/" + save_dir + "/" + date + "\n\n");
                        output_dir ="/vhub/home/public/TitanVhubResults/" + save_dir + "/" + date;
                    }
                    ...
                    //writer4.write("rm -r " + db_path.substring(db_path.lastIndexOf("/") + 1) + "\n\n");
