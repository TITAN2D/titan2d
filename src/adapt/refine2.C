...
void HAdapt_LevelSet::check_create_new_node(const int which, const int Node1, const int Node2,const ti_ndx_t * ndxNodeTemp,
                     SFC_Key NewNodeKey[], ti_ndx_t NewNodeNdx[], const int info, int& RefNe, const int boundary)
{
    double NewNodeCoord[2];
    double norm_coord[2];
...
void HAdapt_LevelSet::check_create_new_node2(const int iElm, const int iNode, const int info, int& RefNe, const int boundary)
{
    ti_ndx_t ndx = new_node_ndx[iElm][iNode];
...
void HAdapt_LevelSet::create_new_node3(const int which, const ti_ndx_t Node1, const ti_ndx_t Node2,
                     SFC_Key NewNodeKey[], ti_ndx_t NewNodeNdx[], const int info)
{
    double NewNodeCoord[2];
    double norm_coord[2];
...
// (0) to (3) also which_sons value
void HAdapt_LevelSet::refineElements(const vector<ti_ndx_t> &allRefinement)
{
    PROFILING3_DEFINE(pt_start);
    PROFILING3_START(pt_start);
