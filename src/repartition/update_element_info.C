 ...
 */
void destroy_element(void *r_element_in, HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr,
...
void construct_el(Element* newelement, ElemPack* elem2, HashTable* HT_Node_Ptr, int myid,
	...
	if (!node) {
		node = new Node(elem2->key, elem2->n_coord[8], elem2->n_info[8], elem2->n_order[8],
		    elem2->node_elevation[8], 8);
