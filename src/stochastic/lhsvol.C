...
int main() {
	printf(
	    "This program generates the latin hypercube sampling (lhs) sample points for the VOLUME SCALE FACTOR for Titan2D.  The resultant volume for a particular run is the product of the scale factor and the base volume entered through the Titan2D python gui\n\n");
