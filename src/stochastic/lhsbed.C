...
int main() {
	printf(
	    "This program generates the latin hypercube sampling (lhs) sample points for the bed friction angle for a single material to be used in Titan2D.\n");
	...
	double A;
	printf(
	    "Enter the number of degrees \"A\" by which the internal friction angle exceeds the bed friction angle\nintfrict = bedfrict + A\n");
	scanf("%lf", &A);
