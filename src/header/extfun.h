...
extern int loadrun(int myid, int numprocs, HashTable** NodeTable, ElementsHashTable** ElemTable,
...
extern void init_piles(ElementsHashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid, int numprocs,
