...
extern void mark_flux_region(HashTable *ElmTable, HashTable *NodeTable, MatProps *matprops,
...
extern double calc_flux(Element *EmTemp, HashTable *NodeTable, FluxProps *fluxprops,
    TimeProps *timeprops);
